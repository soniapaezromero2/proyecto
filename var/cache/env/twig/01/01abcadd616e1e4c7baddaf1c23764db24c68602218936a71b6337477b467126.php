...
class __TwigTemplate_7bcb8a327854e1c9bb75641ee643cdc18d084f80f33d333a95f26b9fa47cb276 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  144 => 42,  139 => 39,  130 => 35,  119 => 29,  115 => 28,  111 => 27,  107 => 26,  102 => 24,  98 => 23,  94 => 21,  89 => 20,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\" style=\"width: 400px;\">
        ...
        {% for user in users %}
            ...
            <tr>
                <td><a href=\"{{ path('app_user_show', {'id':user.id}) }}\">show</a>
    ...
    <a href=\"{{ path('app_user_new') }}\"class=\"btn btn-info w-25\">Create new</a>
</div>
{% endblock %}
", "user/index.html.twig", "/var/www/soniapaezromerostoreonline.live/StoreProjectSoniaPaez/templates/user/index.html.twig");
    }
}
