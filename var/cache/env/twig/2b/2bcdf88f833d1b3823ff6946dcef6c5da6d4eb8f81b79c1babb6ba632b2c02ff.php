...
class __TwigTemplate_23d5b9fbd8956a7a704f63f7500c3526fa83da41a754e00070216f1387237ebf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block body %}
  <div class=\"container\" style=\"background: navajowhite;border: 0;margin-left: 10px;\">
    ...
    <a href=\"{{ path('app_stock_index') }}\"class=\"btn btn-info w-25\">back to list</a>

    {{ include('stock/_delete_form.html.twig') }}
  </div>
{% endblock %}
", "stock/edit.html.twig", "/var/www/soniapaezromerostoreonline.live/StoreProjectSoniaPaez/templates/stock/edit.html.twig");
    }
}
