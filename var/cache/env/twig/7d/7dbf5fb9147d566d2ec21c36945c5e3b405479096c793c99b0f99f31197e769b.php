...
/* user/show.html.twig */
class __TwigTemplate_ea9a96ed31187322fb6b7153dcaaa5557a6729f07184fa35a4bea194d232bc3d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 29
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 29, $this->source); })()), "name", [], "any", false, false, false, 29), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <a href=\"{{ path('app_user_edit', {'id': user.id}) }}\"class=\"btn btn-info w-25\">edit</a>

    {{ include('user/_delete_form.html.twig') }}
    </div>
{% endblock %}
", "user/show.html.twig", "/var/www/soniapaezromerostoreonline.live/StoreProjectSoniaPaez/templates/user/show.html.twig");
    }
}
